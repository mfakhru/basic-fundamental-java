...
public class MultiDimensionalArray {
    public static void main(String[] args) {
        ...
        // Dimensi 1 yang indeksinya 0 memiliki panjang elemen 2
        arrChar[0][0] = 'A';
        arrChar[0][1] = 'B';

        // Dimensi 1 yang indeksinya 1 memiliki panjang elemen 3
        arrChar[1][0] = 'C';
        arrChar[1][1] = 'D';
        arrChar[1][2] = 'E';
...
/*
artinya array bisa lebih dari 1 dimensi
untuk 2 dimensi array bisa menambahkan sumbu y
penulisan []
tanda [] pertama dimensi pertama
tanda [] kedua dimensi kedua, dst
 */
